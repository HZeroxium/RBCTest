...
index_label = tk.Label(
    label_frame,
    text=f"Row {current_index + 1} of {len(df)}",
    font=("Arial", 30, "bold"),
    fg="red",
)
index_label.pack()
...
upper_label = tk.Label(
    upper_frame, text="Invariant Details", font=("Arial", 20, "bold"), fg="blue"
)
upper_label.pack()

upper_textbox = scrolledtext.ScrolledText(
    upper_frame, wrap=tk.WORD, height=10, font=("Arial", 16, "normal")
)
...
lower_textbox = scrolledtext.ScrolledText(
    lower_frame, wrap=tk.WORD, height=10, font=("Arial", 16, "normal")
)
